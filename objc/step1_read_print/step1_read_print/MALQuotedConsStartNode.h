...
typedef NS_ENUM(NSInteger, MALQuotedConsStartNodeType) {
    MALQuotedConsStartNodeTypeQuote,
    MALQuotedConsStartNodeTypeQuasiQuote,
};

@interface MALQuotedConsStartNode : NSObject<MALContainerNode>
